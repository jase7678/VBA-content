...
| _Width_|Required| **Single**|The width of the picture, in points (enter -1 to utilize width of existing file).|
| _Height_|Required| **Single**|The height of the picture, in points (enter -1 to utilize height of existing file).|
